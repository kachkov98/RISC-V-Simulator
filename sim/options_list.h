...
OPTION_DEF(execution_log, bool,     false,   "-execution-log", nullptr,     "enable trace exectuion logging")
OPTION_DEF(log_file,      char *,   nullptr, "-log-file",      "filename",  "write excution output to file")
OPTION_DEF(mem_pages,     size_t,   128,     "-mem-pages",     "pages num", "number of allocated pages")
...
OPTION_DEF(jit_log,       bool,     false,   "-jit-log",       nullptr,     "enable logging of just-in-time-translation")
